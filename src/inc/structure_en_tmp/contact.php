...
<div id="kontakt" class="contact target-offset">
  ...
  <div class="contact__columns__column-wrapper contact__columns__column-wrapper--lg">
    ...
    <div class="contact__columns__column contact__columns__column--50">
      ...
      <div class="contact__calltoactiontext contact__calltoactiontext--primary">Would you like to know more? I want to hear from you!</div>
    ...
    <div class="contact__columns__column contact__columns__column--50">
      ...
      <?php echo do_shortcode( '[contact-form-7 id="56" title="Contact form english"]' ); ?>
