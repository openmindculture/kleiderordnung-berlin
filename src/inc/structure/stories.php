...
<section id="stories" class="stories target-offset">
  ...
  <div class="stories__wrapper carousel__wrapper">
    <div class="stories__viewport carousel__viewport">
      ...
      <!-- Story 1 -->
      <div class="stories__story carousel__item carousel__item--index-0" id="stories-items-first">
      ...
      <!-- Story 2 -->
      <div class="stories__story carousel__item carousel__item--index-1">
        <figure class="stories__story__image">
          <img
      ...
      <!-- Story 3 -->
      <div class="stories__story carousel__item carousel__item--index-2">
        <figure class="stories__story__image">
          <img
            src="<?php echo get_template_directory_uri() ?>/img/maik.jpg" width="321" height="570"
      ...
      <div class="stories__story carousel__item carousel__item--index-3" id="stories-items-last">
