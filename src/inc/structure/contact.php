  ...
  <div class="contact__columns__column-wrapper contact__columns__column-wrapper--lg">
    ...
    <div class="contact__columns__column contact__columns__column--50">
      ...
      <div class="contact__vcard">
        <address class="vcard contact__vcard__address">
          ...
          <div class="contact__vcard__jobtitle jobtitle role" itemprop="jobTitle"><?php
            echo get_field('page_contact_job_title', KLEIDERORDNUNG_FRONT_PAGE_ID)
            ?></div>
          <div class="contact__vcard__phone">Tel.
            <a
              class=telephone
              itemprop=telephone
              href=tel:+491636823820
            ><span class="visually-spaced dot-after">0163</span><span class=visually-spaced>682</span><span class=visually-spaced>382</span><span class=visually-spaced>0</span></a>
          </div>
          <div class="contact__vcard__email">
            <a
              class="contact__vcard__email__mailto email"
              itemprop="email"
              itemscope
              href="#"
              data-mailing="lazy"
          ...
          <a
            ...
            <figure class="socialmedia__icon socialmedia__icon--inverted socialmedia__icon--inverted--substack">
              <svg viewBox="0 0 44 44" fill="non" width="44" height="44">
                ...
                <path
                  fill="#0014d1"
                  d="m 12.000526,9.7174672 h 20.78605 v 2.9139448 h -20.78605 z m 0,10.6288648 h 20.78605 v 13.102077 l -10.395159,-5.83044 -10.390891,5.83044 z m 0,-5.314456 h 20.78605 v 2.913944 h -20.78605 z"
                />
              </svg>
            </figure>
          </a>
    ...
    <div class="contact__columns__column contact__columns__column--50">
      <div class="contact__ctaalternatives">
        <a
          href="<?php echo KLEIDERORDNUNG_CALENDY_URI ?>/15-minute-meeting"
          target="_blank"
          rel="noopener"
