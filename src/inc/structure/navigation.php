  ...
  <div class="inside-navigation grid-container">
    ...
    <div id="primary-menu" class="navigation__list-wrapper navigation__list-wrapper--main">
      ...
      <ul id="menu-main" class="navigation__list navigation__list--main">
        <li id="menu-main-item-angebot" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1857"><a href="<?php echo get_home_url() ?>/#angebot"  tabindex="0">Angebot</a></li>
        <li id="menu-main-item-mission" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1856"><a href="<?php echo get_home_url() ?>/#mission"  tabindex="0">Mission</a></li>
        <li id="menu-main-item-stories" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1855"><a href="<?php echo get_home_url() ?>/#stories"  tabindex="0">Stories</a></li>
        <li id="menu-main-item-news" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1854"><a href="<?php echo get_home_url() ?>/#news"  tabindex="0">News</a></li>
        <li id="menu-main-item-kontakt" class="menu-item menu-item--has-button menu-item-type-post_type menu-item-object-page menu-item-1853"><a class="button button--primary" href="<?php echo get_home_url() ?>/#kontakt" tabindex="0">Kontakt</a></li>
