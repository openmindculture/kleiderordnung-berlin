  ...
  <div class="inside-navigation grid-container">
    ...
    <div id="primary-menu" class="navigation__list-wrapper navigation__list-wrapper--main">
      ...
      <ul id="menu-main-menu" class="navigation__list navigation__list--main">
        <li id="menu-item-1857" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1857"><a href="#angebot"  tabindex="0">Angebot</a></li>
        <li id="menu-item-1856" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1856"><a href="#mission"  tabindex="0">Mission</a></li>
        <li id="menu-item-1855" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1855"><a href="#stories"  tabindex="0">Stories</a></li>
        <li id="menu-item-1854" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1854"><a href="#news"  tabindex="0">News</a></li>
        <li id="menu-item-1853" class="menu-item menu-item--has-button menu-item-type-post_type menu-item-object-page menu-item-1853"><a class="button button--primary" href="#kontakt" tabindex="0">Kontakt</a></li>
