...
<div class="admin__editlink no-print">
  <a href="<?php echo get_admin_url() ?>" class="admin__editlink__link" title="<?php _e( 'Seite bearbeiten', 'kleiderordnung' ) ?> (<?php _e( 'nur sichtbar für angemeldete Administrator:innen', 'kleiderordnung' ) ?>)">
    <span class="admin__editlink__icons">
      <img src="<?php echo get_template_directory_uri() ?>/img/icons/business-woman.svg" width="48" height="48" class="admin__editlink__icon admin__editlink__icon--business-woman" />
      <img src="<?php echo get_template_directory_uri() ?>/img/icons/pencil.svg" width="48" height="48" class="admin__editlink__icon admin__editlink__icon--pencil" />
    </span>
