...
function kleiderordnung_register_custom_page_fields() {
  ...
  acf_add_local_field_group( array(
    ...
    'fields'   => array(
      ...
      array(
        'key'   => 'page_intro_video_subtitles_file_de',
        'name'  => 'page_intro_video_subtitles_file_de',
        'type'  => 'file',
        'label' => 'Deutsche Untertiteldatei (.vtt aus Mediathek auswählen/hochladen)',
      ),
      array(
        'key'   => 'page_intro_video_subtitles_file_en',
        'name'  => 'page_intro_video_subtitles_file_en',
        'type'  => 'file',
        'label' => 'Englische Untertiteldatei (.vtt aus Mediathek auswählen/hochladen)',
      ),
      array(
        'key'   => 'page_intro_video_showsubtitles',
        'name'  => 'page_intro_video_showsubtitles',
        'type'  => 'true_false',
        'label' => 'Untertitel in aktueller Sprache standardmäßig einblenden?',
        'default_value' => 0,
        'ui' => 1,
        'ui_on_text' => 'ja',
        'ui_off_text' => 'nein',
      ...
      array(
        'key'   => 'page_intro_video_captions_file_de',
        'name'  => 'page_intro_video_captions_file_de',
        'type'  => 'file',
        'label' => 'Deutsche Captions Datei für Hörgeschädigte (.vtt aus Mediathek auswählen/hochladen)',
      ),
      array(
        'key'   => 'page_intro_video_captions_file_en',
        'name'  => 'page_intro_video_captions_file_en',
        'type'  => 'file',
